<div class="h-100">
    ...
    <div class="card h-100">
        <div class="card-header">
            <h5>{{ $name }}</h5>
            <div>
                @can('chart info edit') <button type="button" class="btn btn-trans-icon"
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0)"
                                            wire:click="filter_by_implementing_ministry_1('{{ $implementing_ministry_1 }}')">{{ $implementing_ministry_1 }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0)"
                                            wire:click="filter_by_implementing_ministry_2('{{ $implementing_ministry_2 }}')">{{ $implementing_ministry_2 }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
...
$(document).ready(function() {
    //First loaded data
    Highcharts.chart("chart_id_{{ $chart->id }}", {
