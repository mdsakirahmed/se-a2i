...
<body>
    <!-- ======= Header Mobile ======= -->
    <header id="header" class="mobile fixed-top">
        <div class="container d-flex align-items-center
                justify-content-between">

            <h1 class="logo"><a href="{{ route('backend.about') }}"><img src="{{ asset('assets/img/logo3.png') }}" /></a>
            </h1>
                ...
                <ul>
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle p-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span>
                                <p class="mb-0">Hi, <span class="fw-bold">{{
                        ...
                        <ul>
                            @can('role permission management')<li><a href="{{
                                        route('backend.role_permission') }}">Permission
                                    Module</a></li>@endcan
                            @can('user management')<li><a href="{{
                                        route('backend.user_management') }}">User
                                    Module</a></li> @endcan
                            <li><a href="{{ route('backend.profile') }}">My
                                    Profile</a></li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{
                                                    route('backend.about') }}">
                                                <div class="nav-title
                                                        @if(request()->routeIs('backend.about'))
                                                        nav-title-active
                                                        @endif">
                                                    <h6>
                                                        <i class="bx
                                        ...
                                        <li>
                                            <a href="{{
                                                    route('backend.education')
                                                    }}">
                                                <div class="nav-title
                                                        @if(request()->routeIs('backend.education'))
                                                        nav-title-active
                                                        @endif">
                                                    <h6>
                                                        <i class="bx
                                        ...
                                        <li>
                                            <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-1">
                                                <div class="nav-title-collapse
                                                        @if(request()->is('backend/economy/*'))
                                                        nav-title-collapse-active
                                                        @endif">
                                                    <h6>
                                                        <i class="bx
                                                                bx-stats"></i>
                                                    ...
                                                    <div class="arrow">
                                                        ...
                                                        <i class="bx
                                                                bxs-down-arrow
                                                                icon-close" data-aos="fade-up"></i>
                                                    </div>
                                                </div>
                                            </a>
                                            <div id="faq-list-1" class="collapse sub-collapse
                                                    @if(request()->is('backend/economy/*'))
                                                    show @endif" data-bs-parent=".faq-list">
                                                <div class="sub-alignment">
                                                    <a href="{{
                                                            route('backend.economy.overview_of_the_economy')
                                                            }}">
                                                    ...
                                                    <a href="{{
                                                            route('backend.economy.overseas_employment_and_remittance')
                                                            }}">
                                                        <div class="nav-title-sub
                                                    ...
                                                    <a href="{{
                                                            route('backend.economy.import_export')
                                                            }}">
                                                        <div class="nav-title-sub
                                                    ...
                                                    <a href="{{
                                                            route('backend.economy.banking_and_finance')
                                                            }}">
                                                        <div class="nav-title-sub
                                        ...
                                        <li>
                                            ...
                                            <div id="faq-list-3" class="collapse
                                                    sub-collapse" data-bs-parent=".faq-list">
                                                <div class="sub-alignment">
                                                    <a href="{{
                                                            route('backend.health.child-mortality')
                                                            }}">
                                                        <div class="nav-title-sub
                                                    ...
                                                    <a href="{{
                                                            route('backend.health.causes-of-death')
                                                            }}">
                                                        <div class="nav-title-sub
                                                    ...
                                                    <a href="{{
                                                            route('backend.health.maternal-and-child-health-service')
                                                            }}">
                                                        <div class="nav-title-sub
                                                                @if(request()->routeIs('backend.health.maternal-and-child-health-service'))
                                                                sub-active
                                                                @endif">
                                                            <h6>
                                                                {{
                                                    ...
                                                    <a href="{{
                                                            route('backend.health.sdg-analytic-hub')
                                                            }}">
                                                        <div class="nav-title-sub
                                        ...
                                        <li>
                                            <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-2">
                                                <div class="nav-title-collapse
                                                        @if(request()->is('backend/social-protection/*'))
                                                        nav-title-collapse-active
                                                        @endif">
                                                    <h6>
                                                        <i class="bx
                                            ...
                                            <div id="faq-list-2" class="collapse sub-collapse
                                                    @if(request()->is('backend/social-protection/*'))
                                                    show @endif" data-bs-parent=".faq-list">
                                                <div class="sub-alignment">
                                                    <a href="{{
                            ...
                            <ul>
                                ...
                                <li data-aos="fade-up">
                                    ...
                                    <div id="faq-list-1" class="collapse
                                            sub-collapse @if(request()->is('backend/economy/*'))
                                            show @endif" data-bs-parent=".faq-list">
                                        <div class="sub-alignment">
                                            <a href="{{
                                                    route('backend.economy.overview_of_the_economy')
                                ...
                                <li data-aos="fade-up">
                                    ...
                                    <div id="faq-list-2" class="collapse
                                            sub-collapse @if(request()->is('backend/social-protection/*'))
                                            show @endif" data-bs-parent=".faq-list">
                                        <div class="sub-alignment">
                                            <a href="{{
                                                    route('backend.social_protection.budget_and_coverage')
    ...
    <footer id="footer">
        <div class="container py-4">
            <div class="text-center">
                <div class="copyright">
                    &copy; Copyright <strong><span>Socioeconomy</span></strong>.
                    All Rights Reserved
                </div>
            </div>
        </div>
    ...
    <script>
        window.addEventListener('swal:modal', event => {
            swal({ title: event.detail.message , text: event.detail.text , icon: event.detail.type });
        });
