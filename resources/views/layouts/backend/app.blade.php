...
<html lang="en">
    ...
    <body>
                ...
                <nav id="navbar" class="navbar">
                    <ul> 
                        <li class="dropdown">
                            ...
                            <ul>
                                @can('role permission management')<li><a
                                        href="{{
        ...
        <main id="main">
            ...
            <script src="{{
                asset('assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
            <script src="{{ asset('assets/vendor/php-email-form/validate.js')
                }}"></script>
            <script src="{{ asset('assets/vendor/purecounter/purecounter.js')
                }}"></script>
