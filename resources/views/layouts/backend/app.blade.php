                        ...
                        <ul>
                            <li data-aos="fade-up">
                                <a href="{{ route('backend.about') }}">
                                    <div
                                        class="nav-title @if(request()->routeIs('backend.about')) nav-title-active @endif">
                                        <h6>
                            ...
                            <li data-aos="fade-up">
                                <a href="{{ route('backend.education') }}">
                                    <div
                                        class="nav-title @if(request()->routeIs('backend.education')) nav-title-active @endif">
                                        <h6>
                            ...
                            <li data-aos="fade-up">
                                <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-1">
                                    <div
                                        class="nav-title-collapse @if(request()->is('backend/economy/*')) nav-title-collapse-active @endif">
                                        <h6>
                                ...
                                <div id="faq-list-1"
                                     class="collapse sub-collapse @if(request()->is('backend/economy/*')) show @endif"
                                     data-bs-parent=".faq-list">
                                    <div class="sub-alignment">
                                        <a href="{{ route('backend.economy.overview_of_the_economy') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.economy.overview_of_the_economy')) sub-active @endif">
                                                <h6>
                                        ...
                                        <a href="{{ route('backend.economy.overseas_employment_and_remittance') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.economy.overseas_employment_and_remittance')) sub-active @endif">
                                                <h6>
                                        ...
                                        <a href="{{ route('backend.economy.import_export') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.economy.import_export')) sub-active @endif">
                                                <h6>
                                        ...
                                        <a href="{{ route('backend.economy.banking_and_finance') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.economy.banking_and_finance')) sub-active @endif">
                                                <h6>
                            ...
                            <li data-aos="fade-up">
                                <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-2">
                                    <div
                                        class="nav-title-collapse @if(request()->is('backend/social-protection/*')) nav-title-collapse-active @endif">
                                        <h6>
                                ...
                                <div id="faq-list-2"
                                     class="collapse sub-collapse @if(request()->is('backend/social-protection/*')) show @endif"
                                     data-bs-parent=".faq-list">
                                    <div class="sub-alignment">
                                        <a href="{{ route('backend.social_protection.index') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.social_protection.index')) sub-active @endif">
                                                <h6>
                                                    {{ __('Social Protection') }}
                                                </h6>
                                            </div>
                                        ...
                                        <a href="{{ route('backend.social_protection.food_security') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.social_protection.food_security')) sub-active @endif">
                                                <h6>
                                                    {{ __('Food Security') }}
                                                </h6>
                                            </div>
                                        ...
                                        <a href="{{ route('backend.social_protection.budget_and_coverage') }}">
                                            <div
                                                class="nav-title-sub @if(request()->routeIs('backend.social_protection.budget_and_coverage')) sub-active @endif">
                                                <h6>
                            ...
                            @can('role permission management')
                                <li data-aos="fade-up">
                                    <a href="{{ route('backend.role_permission') }}">
                                        <div
                                            class="nav-title @if(request()->routeIs('backend.role_permission')) nav-title-active @endif">
                                            <h6>
                                                <i class="bx bx-key"></i>
                                                {{ __('Role Permission') }}
                                            </h6>
                            ...
                            @can('user management')
                                <li data-aos="fade-up">
                                    <a href="{{ route('backend.user_management') }}">
                                        <div
                                            class="nav-title @if(request()->routeIs('backend.user_management')) nav-title-active @endif">
                                            <h6>
                                                <i class="bx bx-user"></i>
                                                {{ __('User Management') }}
                                            </h6>
