...
class Chart28 extends Component
{
    ...
    public function get_data()
    {
        ...
        ROUND(amount_of_transactions_internet_banking_in_crore_bdt, 1)  AS banking,
        ROUND(amount_of_transactions_mobile_banking_in_crore_bdt, 1) AS mobile,
        ROUND(amount_of_transactions_agent_banking_in_crore_bdt, 1) AS agent
        FROM
